    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-primary">
                ...
                <li class="breadcrumb-item"><a href="/konversi" class="text-white"><?= $breadcrumb[1]; ?></a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="/konversi/add" method="post" id="sync">
                                    <div class="card">
                                        <div class="card-header d-flex justify-content-between">
                                            <div class="header-title">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group mb-4">
                                                        <input type="text" class="form-control" placeholder="Cari menggunakan NPM..." aria-describedby="basic-addon2" name="npmKonversi">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-outline-secondary" type="button" name="btnCariKonversi"><span class="las la-search"></span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <p class="text-left">Kurikulum Ditawarkan</p>
                                                    <select class="form-control" name="kurikulumKonversi">
                                                        <option value="">Pilih Kurikulum Ditawarkan</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <button type="button" class="btn btn-warning float-right" onclick="sync()">Sync >></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php if (!empty(session()->get('dataSession'))) : ?>
                                            <?= view('layout/templateAlert', ['msg' => ['warning', 'ri-check-line', 'Data konversi nilai belum tersimpan, masih ada satu tahapan lagi untuk melakukan penyimpan. Tekan tombol <strong>Simpan</strong> untuk menyimpan nilai konversi']]); ?>
                                        <?php endif ?>
                                        ...
                                        <table class="table table-bordered table-responsive-md table-striped ">
                                            ...
                                            <tbody>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="4" style="text-align: center;">Mata kuliah konversi yang diakui</td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
                                        <a href="/konversi/abort" type="button" class="btn btn-danger"><i class="las la-trash"></i>Batal Sync</a>
                                        <a href="/konversi/proses" type="button" class="btn btn-primary"><i class="las la-plus"></i>Simpan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class=" modal fade" id="cariMatkul" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Matkul Konversi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <table class="table table-bordered table-responsive-md table-striped ">
                    ...
                    <tbody id="matkulKonversi">
                        <tr>
                            <td colspan="4" style="text-align:center ;">Kurikulum ditawarkan belum dipilih</td>
                        </tr>
                    </tbody>
                </table>
