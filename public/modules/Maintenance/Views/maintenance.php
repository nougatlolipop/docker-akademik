                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div style="padding-top:10px; padding-bottom:10px">
                            <center>
                                <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_p5bw8zmp.json" background="transparent" speed="1" style="width: 100%; height: 600px;" loop autoplay></lottie-player>
                            </center>
                        </div>
                    </div>
                </div>
