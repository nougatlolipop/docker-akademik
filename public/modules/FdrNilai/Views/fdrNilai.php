                                ...
                                <tbody>
                                    <?php if (count($datanilai) > 0) : ?>
                                        ...
                                        foreach ($tahunAjar as $key => $value) : ?>
                                            <tr>
                                                <td colspan="9"><strong><?= $value ?></strong></td>
                                            </tr>
                                            <?php foreach ($datanilai as $idx => $krs) : ?>
                                                <?php if ($value == $krs->nama_semester) : ?>
                                                    <tr>
                                                        <td><?= $no++ ?></td>
                                                        <td><?= $krs->nim ?></td>
                                                        ...
                                                        <td style="text-align:center">
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#lihatNilai"><i class="las la-eye"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php endif ?>
                                            <?php endforeach ?>
...
<!-- start modal lihat nilai -->
<div class="modal fade" id="lihatNilai" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
